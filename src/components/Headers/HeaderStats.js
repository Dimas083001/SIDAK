...
export default function HeaderStats() {
  ...
  useEffect(() => {
    const fetchTotalLaporan = async () => {
      try {
        const response = await axios.get("https://api.sidak.lampungsehat.org/jumlah_total_laporan");
    ...
    const fetchTotalBelumIk = async () => {
      try {
        const response = await axios.get("https://api.sidak.lampungsehat.org/menampilkan_status_ik_belum");
