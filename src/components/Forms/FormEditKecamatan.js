...
export default function FormEditKecamatan() {
  ...
  const fetchData = async (nama_kecamatan, id_kota) => {
    try {
      const response = await axios.get(`https://sidak-ils-three.vercel.app/kecamatan-by-nama/${nama_kecamatan}/${id_kota}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://sidak-ils-three.vercel.app/kecamatan/${kecamatan.id}`, kecamatan);
